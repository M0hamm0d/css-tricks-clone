function screenCastSample(arr){
    ...
    arr.forEach(function(item){
        ...
        let guideTime = anchorTagNextSibling.appendChild(document.createElement('div'));
        ...
        let guideExerpt = anchorTagNextSibling.appendChild(document.createElement('div'));
        guideExerpt.className = 'guide-excerpt'
        guideExerpt.appendChild(document.createElement('p')).innerHTML = `${item.paragraph}`;
        let viewMoreButton = anchorTagNextSibling.appendChild(document.createElement('a'));
